package com.example.eko8757.latihananko

import android.graphics.Color
import android.support.v7.app.AppCompatActivity
import android.os.Bundle
import android.support.v4.content.ContextCompat
import com.example.eko8757.latihananko.R.color.colorAccent
        ...
        override fun createView(ui: AnkoContext<MainActivity>) = with(ui) {
            verticalLayout {
                ...
                button("Show Selector") {
                    ...
                    onClick {
                        val club = listOf("Barcelona", "Real Madrid", "Bayern Munchen", "Liverpoo")
                ...
                button("Show progress bar") {
                    ...
                    onClick {
                        indeterminateProgressDialog("Hello, ${name.text}! Please wait...")
                                .show()
                    }
                }.lparams(width = matchParent) {
                    topMargin = dip(5)
